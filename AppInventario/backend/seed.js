...
function seed() {
    return __awaiter(this, void 0, void 0, function () {
        var categories, _i, categories_1, name_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    categories = ['Electrónica', 'Muebles', 'Oficina', 'Limpieza'];
                ...
                case 4:
                    ...
                    return [4 /*yield*/, prisma.proveedor.create({
                            data: {
...
seed().catch(console.error).finally(function () { return prisma.$disconnect(); });
